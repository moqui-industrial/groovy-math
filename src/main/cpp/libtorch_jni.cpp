 ...
 *
 * NOTE: Legacy JNI bridge: retained for historical parity and non-Panama JNI fallback.
 * The primary runtime and production API uses Panama FFM via libtorch_panama.cpp.
 */
