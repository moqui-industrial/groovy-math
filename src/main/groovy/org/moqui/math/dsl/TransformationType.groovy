...
enum TransformationType implements DslEnumValue {
    ...
    UpperTriangExtract('TtMatrixUpperTriang', '', 'Matrix Upper-Triangular Extract', 'TtUnaryLin'),
    LowerTriangExtract('TtMatrixLowerTriang', '', 'Matrix Lower-Triangular Extract', 'TtUnaryLin'),
    BandExtract('TtMatrixBandExtract', '', 'Matrix Band Extract', 'TtUnaryLin'),
    ...
    BlockMatrixExtract('TtBlockMatrixExtr', '', 'Block Matrix Extraction (submatrix) from a Matrix', ''),
