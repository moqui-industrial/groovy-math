...
enum DataType implements DslEnumValue {
    ...
    DataType(final String id, final String enumCode = null, final String description = null, final String parentEnumId = null) {
        this.id = id
    ...
    static DataType fromId(final String id) {
    ...
    static DataType fromCode(final String code) {
    ...
    static DataType fromName(final String name) {
