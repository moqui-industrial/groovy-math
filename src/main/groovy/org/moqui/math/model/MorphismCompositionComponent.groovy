...
@CompileStatic
@EqualsAndHashCode(includes = ['morphismId', 'componentSeqId'])
...
class MorphismCompositionComponent implements Serializable {
    ...
    MorphismCompositionComponent(Map<String, Object> args) {
        if (args != null) {
            ...
            if (args.containsKey('componentSeqId')) this.componentSeqId = args.get('componentSeqId')?.toString()
    ...
    MorphismCompositionComponent componentSeqId(String value) {
        this.componentSeqId = value
        return this;
    }
    ...
    Map<String, Object> toMap() {
        ...
        if (this.componentSeqId != null) map.put('componentSeqId', this.componentSeqId);
