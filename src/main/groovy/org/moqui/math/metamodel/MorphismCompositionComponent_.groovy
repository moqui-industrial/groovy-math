...
import org.moqui.math.model.MorphismCompositionComponent
...
class MorphismCompositionComponent_ {
    ...
    public static final Attribute<MorphismCompositionComponent, String> componentSeqId = new Attribute<>('componentSeqId', MorphismCompositionComponent.class, String.class, true, true)
    public static final Attribute<MorphismCompositionComponent, String> componentMorphismId = new Attribute<>('componentMorphismId', MorphismCompositionComponent.class, String.class, false, true)
