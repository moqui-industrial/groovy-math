...
final class MathDsl {
    ...
    static MathMeta evaluate(final ModelDefinition definition, final File dslFile) {
        ...
        imports.addStarImports('groovy.math.dsl')
    ...
    static MathMeta fluent(final ModelDefinition definition,
                           @DelegatesTo(value = groovy.math.builder.FluentMath, strategy = Closure.DELEGATE_FIRST) final Closure<?> declarations) {
        groovy.math.builder.FluentMath.build(new MathMeta(definition), declarations)
    }
