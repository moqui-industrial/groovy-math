...
class OpenFoamProvider implements MathProvider<OpenFoamPlan, OpenFoamResult> {
    ...
    OpenFoamPlan compile(final MathMeta mathMeta) {
        ...
        String solvingMethod = (model.get('solvingMethodEnumId') ?: 'MmsmOpenFoamIcoFoam') as String
